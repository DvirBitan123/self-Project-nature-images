  ...
  return (
    <div className="grid place-content-center">
      ...
      <img
        ...
        src="http://localhost:8181/public/IMG_1519.jpg"
        alt="Page not found"
      />
      <button 
        className="px-4 py-2 rounded-lg text-xl font-medium text-white bg-gradient-to-r from-pink-500 to-purple-500 ease-out duration-200 hover:from-fuchsia-500 hover:to-cyan-500 hover:p-5"
        onClick={goHome}
      >
        Back Home 
      </button>
